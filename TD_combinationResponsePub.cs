...
namespace ResponsesATSPersonal
{
    ...
    public class TD_combinationResponsePub : ResponseTemplateBasePub
    {
        ...
        [Description("Bars back when calculating TD_combination")]
        ...
        [Description("UseTD_combinationFromATSGlobalIndicator")]
        public Boolean UseTD_combinationFromATSGlobalIndicator { get { return _useTD_combinationFromATSGlobalIndicator; } set { _useTD_combinationFromATSGlobalIndicator = value; } }
        ...
        public TD_combinationResponsePub() : this(true) { }
        public TD_combinationResponsePub(bool prompt)
        {
            _black = !prompt;
        ...
        Boolean _useTD_combinationFromATSGlobalIndicator = true;
        int _entrysize = 1;
        ...
        ATSGlobalIndicatorPersonal.TD_combination _TD_combinationFromATSGlobalIndicator = null;
        bool _black = false;
        Boolean _side = true;
        Decimal _adj = 1;
        Decimal BuySignal = 0;
    ...
    /// <summary>
    /// this is the same as TD_combinationResponse, except it runs without prompting user
    /// </summary>
    public class TD_combinationResponseAutoPub : TD_combinationResponsePub
    {
        public TD_combinationResponseAutoPub() : base(false) { }
    }
}
